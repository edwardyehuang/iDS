...
def read_tesnor_ds_from_tfrecords_dir (example_mapping_fn, input_dir, input_prefix, input_ext = ".tfrecord", compress = False):
    matched_files = []
    ...
    for path in matched_files:
        ds = tf.data.TFRecordDataset(path, compression_type = compress, 
...
def save_tensor_ds_to_tfrecord (ds, example_mapping_fn, output_dir, output_prefix, output_ext = ".tfrecord",
                                                                                   size_split = 4e+9,
                                                                                   compress = False):
